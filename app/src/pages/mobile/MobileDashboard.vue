    ...
    <div class="dashboard-container">
      ...
      <div v-if="activeTab === 'log'" class="tab-content log-tab">
        ...
        <div class="log-summary">
          <button type="button" class="log-summary-card debug-summary" :class="{ active: logFilter === 'debug' }" @click="logFilter = logFilter === 'debug' ? 'all' : 'debug'">
            ...
            <span class="summary-copy">
              <span class="summary-label">调试日志</span>
              <strong>{{ debugLogCount ?? 0 }}</strong>
            </span>
          </button>

          <button type="button" class="log-summary-card error-summary" :class="{ active: logFilter === 'error' }" @click="logFilter = logFilter === 'error' ? 'all' : 'error'">
            <span class="summary-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
