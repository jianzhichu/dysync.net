...
### 有群友为此弄了个小工具，可以一键获取 你抖音的所有需要的信息。
   地址在这里：https://github.com/kevencs/Douyin-User-Info-Extractor 
...
docker run -d --restart=always \
  ...
  -p 10103:10101 \
  --name dysync2025 \
  ccr.ccs.tencentyun.com/jianzhichu/dysync:beta_1.8.2
...
services:
  dysync:
    image: ccr.ccs.tencentyun.com/jianzhichu/dysync:beta_1.8.2
