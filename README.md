...
| 镜像标签          | 架构           | 功能描述                                                              |
| ----------------- | -------------- | --------------------------------------------------------------------- |
| `mini_1.5.8`          | x86_64 (amd64) | **精简版**- 不能下载图文视频           |
| `beta_1.5.8`     | x86_64 (amd64) | **完整版**- 支持图文视频下载与合成 |
| `armmin_1.5.8`      | ARM64          | **ARM 精简版**- 不能下载图文视频                          |
| `arm_1.5.8` | ARM64          | **ARM 完整版**- 支持图文视频下载与合成                   |
...
docker run -d --restart=always \
  ...
  -p 10103:10101 \
  --name dysync2025 \
  ccr.ccs.tencentyun.com/jianzhichu/dysync:beta_1.5.8
...
services:
  dysync:
    image: ccr.ccs.tencentyun.com/jianzhichu/dysync:beta_1.5.8
