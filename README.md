# dysync.net - 抖音同步工具（抖小云）（收藏/喜欢/指定博主，无缝对接Emby/Jellyfin）
...
3. ✅ 图文视频（需要将图片 + mp3 合成视频）

4. ✅ 指定博主的视频

5. ✅ 博主视频可配置是否单独存放一个总文件夹，是否直接用视频标题做文件名

6. ✅ 增加清除日志（防止容器被日志占用太多空间，可配置保留天数）

7. ✅ 界面优化

8. ✅ 将网页名称改成 "抖小云" 灵感来源于哪吒电影 驮门的那个小云云

9. ☐ 增加配置是否对 前面收藏的视频、喜欢的视频、指定博主的视频 这 3 类视频进行去重（考虑到很多情况下，视频既点赞了，又收藏了，可能还被设置到了指定博主。这种情况会出现重复下载。（未完成的，当作下次更新计划）